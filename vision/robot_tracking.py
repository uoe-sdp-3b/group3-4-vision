...
def parse_args():
    ...
    parser.add_argument("-t", help="Our Team Colour", required=True, choices=["yellow", "light_blue"])
    parser.add_argument("-d", help="Number of dots", required=True, choices=["1", "3"])
    parser.add_argument("-b", help="Ball Colour", required=True, choices=["red", "blue"])
